...
Server: Download entire webpage whenever you click a link.

Client: First downloads entire page then proccesses and displays new/updated data without re-downloading the webpage.
